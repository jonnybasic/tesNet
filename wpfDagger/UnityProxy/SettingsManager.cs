...
namespace DaggerfallWorkshopWpf
{
    ...
    public class SettingsManager
    {
        ...
        Dictionary<string, Dictionary<string, string>> defaultIniData = null;
        //IniData userIniData = null;
        Dictionary<string, Dictionary<string, string>> userIniData = null;
...
#else
                    persistentPath = System.IO.Directory.GetCurrentDirectory();
                    //persistentPath = Application.persistentDataPath;
                    //persistentPath = Application.Current.
#endif
                }
        ...
        public void LoadSettings()
        {
            ...
            ToolTipBackgroundColor = GetColor(sectionGUI, "ToolTipBackgroundColor", wpfDagger.Properties.Settings.Default.DaggerfallUnityDefaultToolTipTextColor);
            ToolTipTextColor = GetColor(sectionGUI, "ToolTipTextColor", wpfDagger.Properties.Settings.Default.DaggerfallUnityDefaultToolTipTextColor);
...
#region Private Methods
        ...
        Color32 GetColor(string sectionName, string valueName, Color defaultColor)
        {
            try
            {
                string colorStr = GetData(sectionName, valueName);
                Color result = StringToColor(colorStr).ToColor();
        ...
        void SetColor(string sectionName, string valueName, Color32 value)
        {
