...
namespace DaggerfallWorkshopWpf
{
    ...
    {
        public ImageSource albedoMap;               // Albedo texture out for all colour textures
        public ImageSource normalMap;               // Normal texture out when normals are enabled
        public ImageSource emissionMap;             // Emission texture out for emissive textures
        ...
        public List<Vector> atlasSizes;             // List of sizes for each texture
        public List<Vector> atlasScales;            // List of scales for each texture
        public List<Vector> atlasOffsets;           // List of offsets for each texture
    ...
    public struct CachedMaterial
    {
        ...
        // Textures
        public ImageSource albedoMap;               // Albedo texture of material
        public ImageSource normalMap;               // Normal texture of material
        public ImageSource emissionMap;             // Emission texture of material
        ...
        // Size and scale
        public Vector[] recordSizes;               // Size of texture records
        public Vector[] recordScales;              // Scale of texture records
        public Vector[] recordOffsets;             // Offset of texture records
    }

    /// <summary>
    /// Data package returned by ImageHelper.GetImageData() methods.
    /// Supplied ImageSource will always be readable.
    /// </summary>
    public struct ImageData
    {
        ...
        public ImageSource texture;             // Generated texture
        public ImageSource maskTexture;         // Generated mask texture
        public ImageSource[] animatedTextures;  // Array of animation frames if this is an animated texture
    ...
    public struct ModelData
    {
        ...
        public Point3D[] Vertices;                  // Vector3 array containing position data
        public Vector3D[] Normals;                  // Vector3 array containing normal data
    ...
    public struct ModelDoor
    {
        ...
        public Point3D Vert0;                       // Vertex 0
        public Point3D Vert1;                       // Vertex 1
        public Point3D Vert2;                       // Vertex 2
        public Vector3D Normal;                     // Normal facing away from door
    }
    ...
    public struct StaticDoor
    {
        ...
        public Point3D ownerPosition;               // World position of door owner
        public Quaternion ownerRotation;            // Rotation of door owner
        public Matrix3D buildingMatrix;            // Matrix of individual building owning this door
        ...
        public Point3D centre;                      // Door centre in model space
        public Point3D size;                        // Door size in model space
        public Vector3D normal;                     // Normal pointing away from door
    }
    ...
    public struct StaticBuilding
    {
        ...
        public Matrix3D modelMatrix;               // Matrix of individual model for this building
        public int recordIndex;                     // Record index for building
        public Point3D centre;                      // Building centre in model space
        public Point3D size;                        // Building size
    }
    ...
    public struct BuildingSummary
    {
        ...
        public Point3D Position;                        // Position of building
        public Rotation3D Rotation;                        // Rotation of building
        public Matrix3D Matrix;                        // Transform matrix of building
    ...
    public struct QuestMarker
    {
        ...
        public Point3D flatPosition;                // Position of marker flat in block layout
