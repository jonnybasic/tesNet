...
using DaggerfallWorkshopWpf.Utility;
using UnityEngine;
...
namespace DaggerfallWorkshopWpf
{
    ...
    {
        public static void SetColor(this Material material, int key, Color color)
        {
        ...
        public static void SetTexture(this Material material, int key, ImageSource source)
        {
            ...
            {
                emissive.Brush = brush;
            }
            else if (material is SpecularMaterial specular)
            {
                specular.Brush = brush;
            }
            //RenderOptions.SetEdgeMode(material, EdgeMode.Aliased);
            //RenderOptions.SetBitmapScalingMode(material, BitmapScalingMode.NearestNeighbor);
        }
    }
    ...
    public class MaterialReader// : MonoBehaviour
    {
        ...
        // Window settings
        public Color DayWindowColor = new Color32(89, 154, 178, 0xff).ToColor();
        public Color NightWindowColor = new Color32(255, 182, 56, 0xff).ToColor();
        public Color FogWindowColor = new Color32(117, 117, 117, 0xff).ToColor();
        public Color CustomWindowColor = new Color32(200, 0, 200, 0xff).ToColor();
        ...
        {
            return GetMaterial(archive, record, frame, alphaIndex, out Rect rect, 0, false);
        }
            ...
            bool isBillboard = false)
        {
            ...
            ///else
            {
                ...
                material.SetTexture(Uniforms.MainTex, results.albedoMap);
                ...
                if (results.isEmissive && !results.isWindow && results.emissionMap != null)
                {
                    ...
                    material.SetColor(Uniforms.EmissionColor, Colors.White);
            ...
            Vector[] recordSizes = new Vector[1] { new Vector(size.Width, size.Height) };
            Vector[] recordScales = new Vector[1] { new Vector(scale.Width, scale.Height) };
            Vector[] recordOffsets = new Vector[1] { new Vector(offset.X, offset.Y) };
            ...
            bool isBillboard = false)
        {
            ...
            Vector[] sizesOut, scalesOut, offsetsOut;
        ...
        public Material GetTerrainTilesetMaterial(int archive)
        {
            ...
            //ImageSource texture = TerrainAtlasBuilder.LoadTerrainAtlasTextureResource(archive, CreateTextureAssetResourcesPath);
            //if (texture == null)
        ...
        public void ChangeWindowEmissionColor(Material material, WindowStyle windowStyle)
        {
            switch (windowStyle)
            {
                ...
                case WindowStyle.Disabled:
                    material.SetColor(Uniforms.EmissionColor, Colors.Black);
                    break;
            }
        }
        ...
        private bool ReadyCheck()
        {
            ...
            if (!dfUnity.IsReady)
            {
                DaggerfallWpf3D.LogMessage("MaterialReader: DaggerfallUnity component is not ready. Have you set your Arena2 path?");
                return false;
            }
