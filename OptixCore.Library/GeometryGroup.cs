...
namespace OptixCore.Library
{
    public class GeometryGroup : ContainerNode, IContainerNode<GeometryInstance>, INodeCollectionProvider<GeometryInstance>
    {
        ...
        public NodeCollection<GeometryInstance> Collection => throw new NotImplementedException("Node collection not supported");

        public void AddChild(GeometryInstance instance)
        {
            //mCollection[ChildCount] = instance;
        ...
        public void RemoveChild(int index)
        {
            ...
            SetChild(index, GetChild(ChildCount - 1));
            ChildCount--;
        }
