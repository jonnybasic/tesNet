...
namespace OptixCore.Library
{
    public class GeometryInstance : VariableContainerNode, IContainerNode<Material>, INodeCollectionProvider<Material>
    {
        ...
        public GeometryTriangles GeometryTriangles
        {
            get
            {
                CheckError(Api.rtGeometryInstanceGetGeometryTriangles(InternalPtr, out var geom));
                return new GeometryTriangles(mContext, geom);
            }
            set => CheckError(Api.rtGeometryInstanceSetGeometryTriangles(InternalPtr, value.InternalPtr));
        }
