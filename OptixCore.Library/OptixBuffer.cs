...
namespace OptixCore.Library
{
    ...
    public class OptixBuffer : DataNode
    {
        ...
        public void Resize(ulong width, ulong height, ulong depth)
        {
            mWidth = width;
            mHeight = height;
            mDepth = depth;
        ...
        {
            BufferStream stream = Map();
            try
            {
                MemoryHelper.CopyMemory(destination, stream.DataPointer, (uint)stream.Length);
            }
            finally
            {
                Unmap();
        ...
        public void CopyFrom(Array array)
        {
            ...
            try
            {
                //MemoryHelper.CopyFromManaged<>
                //MemoryHelper.CopyMemory(stream.DataPointer, Marshal.Array)
            }
            finally
            {
                Unmap();
